...
public class ResideMenu extends FrameLayout{
    ...
    private List<Activity> ignoredViews;
    ...
    private void initValue(Activity activity){
        ...
        ignoredViews    = new ArrayList<Activity>();
     ...
     * @param v
     */
    public void addIgnoredView(Activity v){
        ignoredViews.add(v);
    }
    ...
    private boolean isInIgnoredView(MotionEvent ev) {
        Rect rect = new Rect();
        for (Activity v : ignoredViews) {
            v.getWindow().getDecorView().getGlobalVisibleRect(rect);
